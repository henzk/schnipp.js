...
schnipp.dynforms.abstractselect = function(field_descriptor, field_data) {
    ...
    self.selected = self.get_initial_data()
    ...
    // set selected option here as otherwise get_option_by_value is not defined    
    self.selected_option = self.get_option_by_value(self.selected)
